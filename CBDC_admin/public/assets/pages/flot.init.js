...
!function($) {
    ...
    FlotChart.prototype.createDonutGraph = function(selector, labels, datas, colors) {
        ...
        FlotChart.prototype.init = function() {
          ...
          var plabels = ["Wrapbootstrap","Other Market"];
          var pcolors = ['#ebeff2', '#67a8e4'];
          var borderColor = '#f5f5f5';
          var bgColor = '#fff';
          this.createPlotGraph("#website-stats", uploads, downloads, plabels, pcolors, borderColor, bgColor);

          //Pie graph data
          var pielabels = ["Wrapbootstrap","Other Market","Direct Sales"];
          var datas = [20,30, 15];
          var colors = ['#337ab7', '#67a8e4', "#f0f1f4"];
          this.createPieGraph("#pie-chart #pie-chart-container", pielabels , datas, colors);


            //real time data representation
            var plot = this.createRealTimeGraph('#flotRealTime', this.randomData() , ['#67a8e4']);
            plot.draw();
            var $this = this;
            function updatePlot() {
          ...
          var donutlabels = ["Wrapbootstrap","Other Market","Direct Sales"];
          var donutdatas = [29,20, 18];
          var donutcolors = ['#337ab7', '#67a8e4', "#f0f1f4"];
